...
import com.fantasyjitsu.Utility
import com.fantasyjitsu.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(com.fantasyjitsu.login.LoginViewModel::class.java)
